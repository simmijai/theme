...
from products.models import Category  # make sure Category model exists
...
class CategoryCreateView(View):
    template_name = 'admin/category_add.html'
...
class CategoryUpdateView(View):
    template_name = 'admin/category_add.html'  # using same form for simplicity
